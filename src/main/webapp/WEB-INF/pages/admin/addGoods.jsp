...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" >
            <form:form  class="form-horizontal" style="margin:0 auto;width: 550px"  action="adminGoods/addGoods" method="post" modelAttribute="goods" enctype="multipart/form-data">
            ...
            <%--                    <div class="col-sm-10">--%>
            <%--                        <p class="form-control-static"><a href="adminGoods/deleteAGoods?id=${goods.id}&act=updateAGoods" onclick="checkNum()" class="btn btn-default">修改</a></p>--%>
            <%--                    </div>--%>
            <%--                </div>--%>
            <%--            </form>--%>
        </div>
